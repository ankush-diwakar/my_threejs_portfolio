...
const About = () => {
    ...
    const handleCopy = () => {
            //write code to copy email to clipboard
            navigator.clipboard.writeText('work.ankush07@gmail.com');
            setHasCopied(true);
            setTimeout(() => {
                setHasCopied(false);
            }, 2000);
            ...
            <div className='grid h-full grid-cols-1 gap-5 xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2'>
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            <p className="grid-headtext">Hi, I’m Ankush </p>
                    ...
                    <div className="grid-container">
                        <div className="rounded-3xl w-full sm:h-[326px] h-fit flex justify-center items-center">
                            <Globe
                                ...
                                labelsData={[{ lat: 19.075983, lng: 72.877655, text: "Hi I'am here!", color: 'white', size: 15 }]}
                            />
                        </div>
                        <div>
                            <p className="grid-headtext">I’m very flexible with time zone communications & locations</p>
                            <p className="grid-subtext">I&apos;m from Mumbai, India, and open to remote work worldwide.</p>
